...
$.ajax({
  // ajax call to GET songs informations, used handlebars to populate html as well as select options
  url: 'data-json.php',
  method: 'GET',
  success: function success(songs) {
    ...
    for (var i = 0; i < songs.length; i++) {
      ...
      if (optionObject[song.genere] === undefined) {
        // I want an object with all the genres of the songs (without duplicates)
...
function genreFilterHandlebars(optionObject) {
  // this function, thanks to handlebars, populate the select with as many options as genres (no duplicates)
...
__webpack_require__(/*! C:\MAMP\htdocs\PHPEserciziPomeriggio\php-ajax-dischi\src\js\main.js */"./src/js/main.js");
module.exports = __webpack_require__(/*! C:\MAMP\htdocs\PHPEserciziPomeriggio\php-ajax-dischi\src\css\style.scss */"./src/css/style.scss");
